...
**** IN-PROGRESS SmartSense: Monitorer fonctionnement de l'application sans workaround sur nouveau OS
**** IN-PROGRESS SmartSense: Rendre optionnel le mécanisme du workaround pour les crashs d'InfluxDB
