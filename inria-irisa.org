...
**** IN-PROGRESS SmartSense: Étudier la migration vers une nouvelle version d'InfluxDB
...
**** IN-PROGRESS SmartSense: Tester les différentes configurations d'InfluxDB
