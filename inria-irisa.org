...
**** IN-PROGRESS SmartSense: Exécuter le script sur VM 64-bits
...
**** IN-PROGRESS SmartSense: Identifier un SGBD pertinent pour le noeud
...
**** TODO LivingFog: Automatiser la création d'un cluster de Raspberry virtualisé
...
- Réunion de suivi du <2024-04-12 Fri>
  - Préparation
    - Tentative de reproduction du bug sur Raspberry virtualisée
      ...
      - Pas réussi à reproduire le bug dans ces conditions
      ...
      - Pistes suivies
        - Faire tourner la simulation de charge sur le noeud SmartSense
        - Faire tourner le noeud SmartSense en ignorant les entrées particulières
          - i.e. les images thermiques et le stream audio
      - Conclusions
