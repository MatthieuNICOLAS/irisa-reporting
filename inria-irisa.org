...
*** Planned
**** IN-PROGRESS Magellan: Préparer présentation sur CRDTs
...
- Magellan: Préparer présentation sur CRDTs
  - Plan
    ...
    - [ ] Challenges of data replication in peer-to-peer systems
    ...
    - [ ] Use-cases
      ...
      - Multi-master replication for geo-distributed datacenters (Redis)
    - [ ] Ongoing research topics
      - Designing CRDTs for new data types
        - Tree data type
