...
- Utiliser un outil d'automatisation de la configuration, genre *Ansible*, permettrait
...
**** IN-PROGRESS SmartSense: Suivre le comportement d'InfluxDB avec une shard duration de 1h
