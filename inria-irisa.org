...
- Faire la MR
**** IN-PROGRESS SmartSense: Recréer une image QEMU RPi 64-bits
...
**** TODO SmartSense: Créer une image QEMU RPi 32-bits
...
**** TODO SmartSense: Mesurer les différentes métriques des données produites par le noeud SmartSense
...
- Métriques à observer
  ...
  - Débit en écriture
  - Volume des valeurs
**** TODO SmartSense: Configurer Inch pour simuler le plus fidèlement le workload du RPi
