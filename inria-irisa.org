...
**** TODO SmartSense: Revert la version de l'application à avant le workaround pour InfluxDB
...
**** TODO SmartSense: Intégrer la branche *refactor/naming-conventions*
- Préparer la MR, en attendant l'intégration de *refactor/main-app*
**** TODO SmartSense: Traiter les problèmes relevés lors de l'uniformisation du code
