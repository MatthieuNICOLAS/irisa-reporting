...
- Magellan: Préparer présentation sur CRDTs
  ...
  - Reste à
    - [ ] Remplacer figure pour Op-based CRDTs par scénario plus simple
    - [ ] Animer les figures
    - [ ] Améliorer slide de synthèse
...
- Réunion Guillaume
  ...
  - Questions
    ...
    - [ ] Server PC déployé ?
    - [ ] Server PC communique avec clusters ?
    - [ ] À terme, utiliser kubeadm ou k3s ?
